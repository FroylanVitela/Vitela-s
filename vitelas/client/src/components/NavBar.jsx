...
function IcoAbout(p) {
  return (
    <svg {...p} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <header ref={headerRef} className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      ...
      <div className="navbar-inner">
        ...
        <nav className="nav-links" aria-label="Principal">
          ...
          <NavLink to="/about" className="nav-link"><IcoAbout className="nav-ico" /> Nosotros</NavLink>
